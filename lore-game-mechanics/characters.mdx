...
description: "Merged student character index and profiles, plus template and integration notes."
tags: ["lore", "characters", "merged"]
stability: draft
lastUpdated: 2025-09-24
---

## Student Characters (Index)

Canonical student operatives, strategists, and researchers within the setting.
...
Guidance for adding a new student character profile.
...
| ---------------- | ------------------------------------------------ | ------- |
| API Linkage      | Cross-link student profiles to bonded Aetherbots | Planned |
