...
description: "A 5-minute primer: the Loom, Patterns, Harmonization, and where Fray fits."
...
Sentient constructs of living code that manifest a primary Pattern (element + emotional Thread). They can form bonds with students.
