...
description: Persistent representation of an Academy – the institutional node where humans, aetherbots, and progression systems converge in the aetherbot domain.
status: experimental
