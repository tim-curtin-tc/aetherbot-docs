---
title: "Supporting: Purchase Order Entity"
slug: domain/entities/supporting/purchase-order
description: Instructional commercial order capturing intent to acquire SKUs (packs, entitlements) prior to fulfillment.
status: experimental
...
| Buyer      | accountId / studentId depending on auth context. |
...
| buyerStudentId  | ID(Student)                | Optional explicit student.                         |
