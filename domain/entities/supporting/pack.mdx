---
title: "Supporting: Pack Entity"
slug: domain/entities/supporting/pack
description: Configured bundle definition enabling probabilistic card (and optional asset) distribution through an opening event.
status: experimental
